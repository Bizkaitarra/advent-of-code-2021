...
use AOC\Day2\Instructions\Down;
use AOC\Day2\Instructions\Forward;
use AOC\Day2\Instructions\Instruction;
use AOC\Day2\Instructions\InstructionNotSupportedException;
use AOC\Day2\Instructions\Up;
